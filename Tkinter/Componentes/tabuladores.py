...
ventana = tk.Tk()
ventana.geometry('650x400+450+200') # Lo que esta en mas es para especificar donde debe aparecer
ventana.title('Componenetes')
...
def crear_componentes_tabulador5(tabulador):
    ...
    def detener_despues():
        esperar_ms = 1000
        ventana.after(esperar_ms, barra_progreso.stop) # espues de 1 segundo, parar
